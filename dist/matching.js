export function createMatcher(config, query) {
    if (config.regex) {
        return {
            mode: 'js-regex',
...
function buildJsRegex(source, wholeWord, caseSensitive) {
...
export function expandReplacementTemplate(match, replacement, input) {
